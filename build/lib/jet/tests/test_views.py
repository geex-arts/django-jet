...
class ViewsTestCase(TestCase):
    ...
    def test_module_update_view(self):
        ...
        response = self.admin.get(reverse('update_module', kwargs={'pk': module.pk}))
        ...
        self.admin.post(reverse('update_module', kwargs={'pk': module.pk}), post)
        self.assertEqual(response.status_code, 200)
    ...
    def test_update_dashboard_modules_view(self):
        ...
        response = self.admin.post(reverse('update_dashboard_modules'), {
            'app_label': '',
            'modules': json.dumps([
    ...
    def test_add_user_dashboard_module_view(self):
        response = self.admin.post(reverse('add_user_dashboard_module'), {
            'app_label': '',
    ...
    def test_update_dashboard_module_collapse_view(self):
        ...
        response = self.admin.post(reverse('update_dashboard_module_collapse'), {
    ...
    def test_remove_dashboard_module_view(self):
        ...
        response = self.admin.post(reverse('remove_dashboard_module'), {'id': module.pk})
        self.assertEqual(response.status_code, 200)
        response = json.loads(response.content.decode())
        self.assertFalse(response['error'])
